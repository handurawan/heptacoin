 ...
 * between heptacoind, and heptacoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("heptacoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/heptacoin/heptacoin>";
    const std::string URL_WEBSITE = "<https://heptacoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("heptacoin-loadblk");
    CImportingNow imp;
...
/** Sanity checks
 *  Ensure that Heptacoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Heptacoin version %s\n", FormatFullVersion());
}

/** Initialize heptacoin.
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Heptacoin process is using the data directory.
