...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(string("createrawtransaction ")+prevout+" "+
      "{\"HPLcJRM77NKfzBGUR7hr6FdVtmveq3YA8e\":11}");
...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(699999999999990LL).write() == "6999999.99999990");
    BOOST_CHECK(ValueFromAmount(699999999999999LL).write() == "6999999.99999999");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("6999999.9999999")), 699999999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("6999999.99999999")), 699999999999999LL);
...
BOOST_AUTO_TEST_CASE(json_parse_errors)
{
    ...
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("1.0]"), std::runtime_error);
    // HEPTA addresses should fail parsing
